...
export default async function HomePage() {
  ...
  const [groups, recentSearches, version] = userId
    ? await Promise.all([
  ...
  return (
    <div className={userId ? styles.layout : undefined}>
      <div className={userId ? styles.main : undefined}>
      ...
      {userId && version ? (
        <aside className={styles.sidebar}>
          <ActivityFeedSidebar version={version} />
        </aside>
      ) : null}
    </div>
  );
